 ...
 * When we need a shift in additional prime fields (not in the safe mode), we
 ...
 polynomials with less or equal terms than the maximal number (including terms
 ...
 sparsely.
 In general, this leads to less required black-box probes than a dense approach
